...
<head>
  ...
  <script type="text/javascript" src="/static/js/jquery.githubRepoWidget2.js"></script>
  ...
  <script type="text/javascript">
    ...
    function GroupBegDbg() {
      groupBeg(DEBUG);
    };

    function GroupEndDbg() {
      groupEnd(DEBUG);
    };

    function groupBeg(group) {
      if (window["console"]) {
        console.group(group)
      }
    };
...
<body>
  <header id="header">
    <div class="github-widget" data-repo="CodyGuo/xcgui" style="margin: 5px;"></div>
    <br><br>
    <div class="nav nav-pills" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          <a class="navbar-brand" href=".">网络诊断工具</a>
        </div>
      </div>
    </div>
  </header>
  <div id="wrap" class="container col-center-block">
    <form class="form-inline" id="ping-Addr">
      <div class="input-group">
        <div class="input-group-btn" style="width: 102px;">
          <button id="menutools" type="button" class="btn btn-primary dropdown-toggle btn-block" data-toggle="dropdown"><span id="js_mode" data-type="0">ping</span> <span class="caret"></span></button>
          <ul class="dropdown-menu" role="menu">
            <li><a href="javascript:selectMode(lping)">ping</a></li>
            <li><a href="javascript:selectMode(ltcpdump)">抓包工具</a></li>
            <li><a href="javascript:selectMode(ltraceroute)">traceroute</a></li>
            <li><a href="javascript:selectMode(lnslookup)">nslookup</a></li>
          </ul>
        </div>
        <input id="ipAddr" type="text" class="form-control" placeholder="请输入参数！">
        <div class="input-group-btn">
          <button id="pingBtn" class="btn btn-primary" type="button">执行</button>
        </div>
      </div>
    </form>
    <div id="output">
