...
* 解决方法：在Github上下载压缩包版手动安装https://github.com/SublimeText/Tag 将解压的Tag-st3放在sublime text目录\Data\Packages下，重启快捷键能用。
...
### 2.8 Preferences-->Package Settings-->CTags-->Settings-User:
    {
        // Enable debugging
        "debug": false,
        // Enable autocomplete
